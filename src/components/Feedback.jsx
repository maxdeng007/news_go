            ...
            <>
              ...
              <div className="flex items-center justify-center gap-4">
                <button
                  ...
                  className="flex flex-col items-center gap-2 px-6 py-4 glass-btn text-[var(--color-text-secondary)] rounded-xl hover:text-[var(--color-positive)] hover:border-[var(--color-positive)] hover:shadow-[0_0_20px_rgba(34,211,238,0.3)] transition-all duration-200 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 px-6 py-4 glass-btn text-[var(--color-text-secondary)] rounded-xl hover:text-[var(--color-negative)] hover:border-[var(--color-negative)] hover:shadow-[0_0_20px_rgba(244,114,182,0.3)] transition-all duration-200 cursor-pointer"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
